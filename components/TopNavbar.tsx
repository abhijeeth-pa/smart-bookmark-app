        ...
        <div className="flex-1 w-full sm:w-auto sm:max-w-md">
          <div className="relative">
            ...
            <input
              ...
              className="block w-full pl-10 pr-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent outline-none text-gray-900"
            />
            {localSearch && (
              <button
        ...
        <div className="flex gap-3 w-full sm:w-auto">
          ...
          <div className="flex-1 sm:flex-initial">
            <select
              ...
              className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent outline-none bg-white cursor-pointer text-purple-700 font-medium"
            >
